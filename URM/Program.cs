...
var fullState = new URM.Models.QuantumState(20);
...
{
    double d = URM.Mathematics.DimensionFunctions.D(rho);
    var projected = URM.Models.LensOperator.Apply(fullState, rho);
